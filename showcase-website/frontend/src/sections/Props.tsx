        ...
        <table className="props__table">
          ...
          <tbody>
            ...
            <tr>
              ...
              <td className="props__cell">Array</td>
              <td className="props__cell">An array of objects that define the rows of the data grid.</td>
            </tr>
            <tr>
              <td className="props__cell">onRowClick</td>
              <td className="props__cell">Function</td>
              <td className="props__cell">
                A function that is called when a row is clicked. It receives the
                row object as an argument.
              </td>
            </tr>
            <tr>
              ...
              <td className="props__cell">Function</td>
              <td className="props__cell">
                A function that is called when a column is sorted. It receives
                the field and direction as arguments.
              </td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td className="props__cell">Function</td>
              <td className="props__cell">
                A function that is called when a row is deleted. It receives the
                row object as an argument.
              </td>
            </tr>
            <tr>
